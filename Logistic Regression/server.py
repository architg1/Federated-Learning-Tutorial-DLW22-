...
if __name__ == "__main__":
    ...
    fed_avg_m_strategy = fl.server.strategy.FedAvgM(
        ...
        evaluate_fn=get_evaluate_fn(model),
        on_fit_config_fn=fit_round,
        server_learning_rate=1,  # AssertionError: When using server-side optimization, model needs to be initialized.
        server_momentum=0.00     # AssertionError: When using server-side optimization, model needs to be initialized.
    )
